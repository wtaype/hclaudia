import{$ as i,N as o,j as w,z as D,d as v,a as u,A as h,B as E,i as I,x as H,b as k,c as y,l as $,t as O,y as m,q as S,e as A,h as N,v as M,M as x}from"./widev-BOjYXDSJ.js";import{a as C}from"./habEstado-DrRNyQ4K.js";let r=[],d=null;async function p(a){d=a;try{const t=H("habitacionesControl");if(t&&t.length>0){r=t,f();return}r=(await k(y(u,"habitaciones"))).docs.map(e=>({id:e.id,...e.data()})),$("habitacionesControl",r,300),f()}catch(t){console.error("Error carga:",t),o("Error al cargar habitaciones","error")}}function f(){const a=`

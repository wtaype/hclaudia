import{$ as s,t as p,v,x as n,a as l,b as h,q as u,c as b,e as f,l as m,h as d,y as g,M as $}from"./widev-B94L0ewu.js";import{h as y,c as w,a as C}from"./habEstado-D67mFonU.js";window.footer=x;const k=2024,D="@wilder.taype",S="https://wtaype.github.io/",P="v15";function x(){const o=new Date;return`
  <footer class="foo wb txc psa">
    <span>Creado con <i class="fas fa-heart"></i> by <a class="ftx lkme" href="${S}" target="_blank">${D}</a></span>
    <span>${k} - <span class="wty">${o.getFullYear()}</span></span>
    <span class="abw"> | Acerca del app ${P} | actualizado:
    <span class="wtu">${o.toLocaleString()}</span></span>
  </footer>
  `}s("style").append(".foo{width:100%;text-align:center;padding-block:1.5vh 1vh;background:var(--wb);border-radius:1vh 1vh 0 0;}.foo *{font-size:var(--fz_s2);margin-inline:.3vh;}.foo a{color:var(--bg2);}.foo i{color:var(--mco);}.abwc{background:var(--bg);top:0;width:99%;height:100%;padding:2vh 2vw;overflow:scroll;line-height:1.80;}.abwok{background:var(--mco);color:var(--txa);}");let t=null;p(d,async o=>{if(!o)return window.location.href="/";t=o;try{const a=v("wiSmile");if(a)return c(a),n(l,t);const e=(await h(u(b(l,"smiles"),f("usuario","==",o.displayName)))).docs[0].data();m("wiSmile",e,450),c(e),n(l,t)}catch(a){console.error(a)}});s(document).on("click",".bt_salir",async()=>{await g(d),window.location.href="/";try{localStorage.clear()}catch{Object.keys(localStorage).forEach(a=>localStorage.removeItem(a))}});function c(o){$(`Bienvenido ${o.nombre}!`),s(".app").html(`
  ...
  `).join(""),M=()=>[{id:"totReg",label:"Total",icon:"fa-clipboard-check",color:"#22c55e",val:"0"},{id:"numHab",label:"Habitaciones",icon:"fa-bed",color:"#3b82f6",val:"0"},{id:"ingTot",label:"Ingreso",icon:"fa-coins",color:"#fbbf24",val:"S/ 0.00"},{id:"proNoc",label:"Prom/Noche",icon:"fa-chart-line",color:"#a855f7",val:"S/ 0.00"}].map(a=>`
    <div class="info-card">

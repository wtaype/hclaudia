 ...
 */function iE(n){n=on(n,We);const e=on(n.firestore,Ii);return yT(Ku(e),n._key).then((t=>MT(e,n,t)))}oi._jsonSchemaVersion="firestore/querySnapshot/1.0",oi._jsonSchema={type:Xe("string",oi._jsonSchemaVersion),bundleSource:Xe("string","QuerySnapshot"),bundleName:Xe("string"),bundle:Xe("string")};class hd extends xT{constructor(e){super(),this.firestore=e}convertBytes(e){return new Dt(e)}convertReference(e){const t=this.convertDocumentKey(e,this.firestore._databaseId);return new We(this.firestore,null,t)}}function sE(n){n=on(n,lr);const e=on(n.firestore,Ii),t=Ku(e),r=new hd(e);return NT(n._query),_T(t,n._query).then((i=>new oi(e,r,n,i)))}function LT(n,e,t){n=on(n,We);const r=on(n.firestore,Ii),i=VT(n.converter,e,t);return sc(r,[ST(Xu(r),"setDoc",n._key,i,n.converter!==null,t).toMutation(n._key,jt.none())])}function oE(n,e,t,...r){n=on(n,We);const i=on(n.firestore,Ii),a=Xu(i);let c;return c=typeof(e=Ye(e))=="string"||e instanceof ca?RT(a,"updateDoc",n._key,e,t,r):CT(a,"updateDoc",n._key,e),sc(i,[c.toMutation(n._key,jt.exists(!0))])}function aE(n){return sc(on(n.firestore,Ii),[new Du(n._key,jt.none())])}function sc(n,e){return(function(r,i){const a=new Tn;return r.asyncQueue.enqueueAndForget((async()=>sT(await mT(r),i,a))),a.promise})(Ku(n),e)}function MT(n,e,t){const r=t.docs.get(e._key),i=new hd(n);return new kr(n,i,e._key,r,new cs(t.hasPendingWrites,t.fromCache),e.converter)}function FT(){return new Yu("serverTimestamp")}(function(e,t=!0){(function(i){_i=i})(mi),ai(new Nr("firestore",((r,{instanceIdentifier:i,options:a})=>{const c=r.getProvider("app").getImmediate(),p=new Ii(new by(r.getProvider("auth-internal")),new Ry(c,r.getProvider("app-check-internal")),(function(v,I){if(!Object.prototype.hasOwnProperty.apply(v.options,["projectId"]))throw new ee(H.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new Ts(v.options.projectId,I)})(c,i),c);return a={useFetchStreams:t,...a},p._setSettings(a),p}),"PUBLIC").setMultipleInstances(!0)),Jn(qc,Bc,e),Jn(qc,Bc,"esm2020")})();const UT={apiKey:"AIzaSyAzv2oTdgp37bCGUckKpEfzDYZAjjT32Kg",authDomain:"registrohclaudia.firebaseapp.com",projectId:"registrohclaudia",storageBucket:"registrohclaudia.firebasestorage.app",messagingSenderId:"1039550565894",appId:"1:1039550565894:web:69a2a4b3c587df6f54fd87"},fd=Ql(UT),uE=Ey(fd),cE=ET(fd),lE=(()=>{const n=[["Cielo","#0EBEFF"],["Dulce","#FF5C69"],["Paz","#29C72E"],["Mora","#7000FF"],["Futuro","#21273B"]];let e,t;const r=a=>{const c=Ce(a).data("tema");if(!c)return!1;const[p,_]=c.split("|");if(!p||!_)return!1;Ce("html").attr("data-theme",p);const v=Ce('meta[name="theme-color"]');return v.length?v.attr("content",_):Ce("<meta>",{name:"theme-color",content:_}).appendTo("head"),qT("wiTema",c,720),Ce(".mtha").removeClass("mtha"),Ce(a).addClass("mtha"),t=c,!0},i=async(a,c)=>{if(!(!a||!c?.displayName||!t))try{await LT(TT(a,"preferencias",c.displayName),{usuario:c.displayName,email:c.email,wiTema:t,fechaActualizacion:FT()},{merge:!0});const[p]=t.split("|");jT(`Tema ${p} guardado 🎨`)}catch(p){console.error("❌ Error guardando tema:",p)}};return(a,c)=>{Ce(".witemas").html(n.map(([v,I])=>`<div class="tema" data-tema="${v}|${I}" style="background:${I}"></div>`).join(""));const p=BT("wiTema"),_=Ce(`[data-tema="${p}"]`)[0]||Ce(".mtha")[0]||Ce("[data-tema]").first()[0];_&&r(_),Ce(document).off("click.witema").on("click.witema","[data-tema]",v=>{!r(v.currentTarget)||!a||!c?.displayName||(clearTimeout(e),e=setTimeout(()=>i(a,c),50))})}})(),hE=n=>{Ce("#loading-style").length||Ce("head").append('<style id="loading-style">.loading{height:1vh;background:linear-gradient(to right,#ffd105,#1e3a8a,#ffd105);background-size:200% 100%;animation:l 1.5s infinite;border-radius:3px;width:100%;position:fixed;top:0;left:0;z-index:9999}@keyframes l{0%{background-position:0% 50%}50%{background-position:100% 50%}100%{background-position:0% 50%}}</style>'),Ce(".loading").length||Ce("body").append('<div class="loading" style="display:none"></div>'),Ce(".loading").toggle(!!n)},fE=n=>{const e=n==="smiletop"?"smiletop.html":"smile.html";window.location.href=new URL(e,window.location.href).toString()};function dE(n,e="error",t=3e3){const r={success:"fa-check-circle",error:"fa-times-circle",warning:"fa-exclamation-triangle",info:"fa-info-circle"},i={success:"#2E7D32",error:"#D32F2F",warning:"#F9A825",info:"#0288D1"};Ce("#notificationsContainer").length||Ce("body").append('<div id="notificationsContainer" style="position:fixed;top:1rem;right:1rem;z-index:9999;display:flex;flex-direction:column;gap:.5rem;"></div>');const a=Ce(`
  ...
  `);Ce("#notificationsContainer").append(a),requestAnimationFrame(()=>a.css({opacity:1,transform:"translateX(0)"})),a.find("button").on("click",()=>{a.css({opacity:0,transform:"translateX(20px)"}),setTimeout(()=>a.remove(),300)}),setTimeout(()=>{a.css({opacity:0,transform:"translateX(20px)"}),setTimeout(()=>a.remove(),300)},t)}const pE=n=>{const[e,t,r]=n.split("-").map(Number);return new Date(e,t-1,r)},jT=(n,e="success")=>{Ce(".alert-box").remove();const t={error:{bg:"#FFE8E6",txt:"#D32F2F",border:"#FFCDD2",icon:"fa-circle-exclamation"},success:{bg:"#E8F5E9",txt:"#2E7D32",border:"#C8E6C9",icon:"fa-circle-check"}},{bg:r,txt:i,border:a,icon:c}=t[e]||t.error,p=Ce(`

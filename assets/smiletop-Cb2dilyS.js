import{$ as i,N as o,j as H,z,d as v,a as u,A as h,B as D,i as E,v as w,b as k,c as y,l as $,t as I,x as m,q as O,e as S,h as N,y as A,M}from"./widev-DWYmvaYH.js";import{b as x}from"./habEstado-BqeKe2x8.js";let r=[],d=null;async function p(a){d=a;try{const t=w("habitacionesControl");if(t&&t.length>0){r=t,f();return}r=(await k(y(u,"habitaciones"))).docs.map(e=>({id:e.id,...e.data()})),$("habitacionesControl",r,300),f()}catch(t){console.error("Error carga:",t),o("Error al cargar habitaciones","error")}}function f(){const a=`

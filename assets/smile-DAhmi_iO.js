import{t as p,v,x as s,a as l,b as u,q as h,c as b,e as m,l as f,h as d,$ as c,y as g,M as $}from"./widev-B94L0ewu.js";import{f as y}from"./footer-DcbBJITX.js";import{h as C,c as D,a as S}from"./habEstado-D67mFonU.js";let t=null;p(d,async o=>{if(!o)return window.location.href="/";t=o;try{const a=v("wiSmile");if(a)return n(a),s(l,t);const e=(await u(h(b(l,"smiles"),m("usuario","==",o.displayName)))).docs[0].data();f("wiSmile",e,450),n(e),s(l,t)}catch(a){console.error(a)}});c(document).on("click",".bt_salir",async()=>{await g(d),window.location.href="/";try{localStorage.clear()}catch{Object.keys(localStorage).forEach(a=>localStorage.removeItem(a))}});function n(o){$(`Bienvenido ${o.nombre}!`),c(".app").html(`
  ...
  `).join(""),w=()=>[{id:"totReg",label:"Total",icon:"fa-clipboard-check",color:"#22c55e",val:"0"},{id:"numHab",label:"Habitaciones",icon:"fa-bed",color:"#3b82f6",val:"0"},{id:"ingTot",label:"Ingreso",icon:"fa-coins",color:"#fbbf24",val:"S/ 0.00"},{id:"proNoc",label:"Prom/Noche",icon:"fa-chart-line",color:"#a855f7",val:"S/ 0.00"}].map(a=>`
    <div class="info-card">
